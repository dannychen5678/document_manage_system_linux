...
class Config:
    ...
    # 基本配置
    SQLALCHEMY_DATABASE_URI ='postgresql://document_manage_system_database_user:1XEOOmaxwIrUiyul7RZANgaiaQrLIPqr@dpg-cvr6r56uk2gs73cakpa0-a.oregon-postgres.render.com/document_manage_system_database'
